...
export default function GenerateAI() {
    ...
    const showNtification = useAppStore((state) => state.showNotification)
    ...
    return (
      <>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="relative">
              ...
              <button 
                type="submit" 
                aria-label="Enviar"
                className={`cursor-pointer absolute top-1/2 right-5 transform -translate-x-1/2 -translate-y-1/2 ${isGenerating ? "cursor-notallowed opacity-50": "" }`}
          ...
          {isGenerating &&  <p className="text-center animate-wiggle">Generando...</p>}
